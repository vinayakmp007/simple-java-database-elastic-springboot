...
public class NewInactiveSuggestionIterTest {
    ...
    public void testDaoFunction() {
        ...
        try {
            ...
            NewInactiveSuggestionIter instance = (NewInactiveSuggestionIter) DAOIteratorFactory.NewSuggesionIterator(true, newTime, null, page);
    ...
    public void testIterator() {
        ...
        while (removeactiveIterator.hasNext()) {
            ...
            if (!temp.isDeleted()) {
                removeactiveIterator.remove();
            }
        }
        for (int pageSize = 1; pageSize <= 30; pageSize++) {
            Pageable page = PageRequest.of(0, pageSize, Sort.by("id"));
            Iterator<Suggestion> instance = (NewInactiveSuggestionIter) DAOIteratorFactory.NewSuggesionIterator(true, newTime, null, page);
